...
describe('Item Updater Factory', () => {
  it('should create an instance', () => {
    ...
    expect(itemUpdaterFactory).to.be.an.instanceOf(ItemUpdaterFactory);
  });
  ...
  it('should create an Backstage Passes Item Updater', () => {
    ...
    expect(itemUpdater).to.be.an.instanceOf(BackstagePassesItemUpdater);
  });
  ...
  it('should create an Standard Item Updater', () => {
    ...
    expect(itemUpdater1).to.be.an.instanceOf(StandardItemUpdater);
    expect(itemUpdater2).to.be.an.instanceOf(StandardItemUpdater);
  });
});
